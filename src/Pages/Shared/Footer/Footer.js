...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-5 bg-black-900 bg-opacity-70 bg-clip-padding backdrop-filter backdrop-blur-xl border-y-2 border-red-500  mt-10 justify-around">
                <div>
                    ...
                    <p>©Rahat Ashik<br></br>GameMaster LTD. 2022</p>
                </div>
                <div>
